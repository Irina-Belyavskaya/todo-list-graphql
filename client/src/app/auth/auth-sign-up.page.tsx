...
import { SIGN_UP } from "app/graphql/users";
...
export default function AuthSignUpPage() {
  ...
  const [signup, { data, loading, error }] = useMutation(SIGN_UP, {
    onCompleted(data){
      reset();
      Cookies.set('jwt_token', data.signup.access_token);
      Cookies.set('expired_at', data.signup.expired_at);
